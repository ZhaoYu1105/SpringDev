...
SMART_MAINCLASS="com.cmcc.dhome.device.server.run.DeviceClientRun"
SMART_USER=""
SMART_NAME="Device-Server"
SMART_PIDFILE="$SMART_HOME/$SMART_NAME.pid"
SMART_STOP_PIDFILE="$SMART_HOME/$SMART_NAME-stop.pid"
SMART_OPTS_MEMORY="-server -Xms1024m -Xmx1024m -XX:NewSize=600m -XX:MaxNewSize=600m -XX:PermSize=128M -XX:MaxPermSize=128m -XX:+UseG1GC -Ddruid.registerToSysProperty=true"
