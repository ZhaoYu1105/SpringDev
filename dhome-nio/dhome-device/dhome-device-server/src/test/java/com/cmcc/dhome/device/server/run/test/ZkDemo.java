/**
 * @ dhome-device-server
 * @ com.cmcc.dhome.device.server.run.test
 * @ ZKDemo.java
 * 
 * @author liujianliang@chinamobile.com 2016年6月28日
...
public class ZkDemo {
    ...
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        // 创建一个与服务器的连接
        ZooKeeper zk = new ZooKeeper("192.168.192.213:2181,192.168.192.214:2181,192.168.192.215:2181", 60000, new Watcher() {
            // 监控所有被触发的事件
